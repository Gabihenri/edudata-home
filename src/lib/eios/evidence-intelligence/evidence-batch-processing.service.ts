...
function validateProcessingRequest(
  ...
  if (
    ...
    errors.push(
      'O identificador da requisiÃ§Ã£o de processamento Ã© obrigatÃ³rio.',
    )
  }
  ...
  if (
    ...
    errors.push(
      'A requisiÃ§Ã£o deve conter ao menos uma evidÃªncia.',
    )
  }
  ...
  if (
    ...
    errors.push(
      `O lote excede o limite de ${configuration.maximumEvidencePerBatch} evidÃªncias.`,
    )
  }
  ...
  if (
    ...
    errors.push(
      'A data da requisiÃ§Ã£o Ã© invÃ¡lida.',
    )
  }
  ...
  for (
    ...
    if (
      ...
      errors.push(
        `A evidÃªncia "${evidence.id}" estÃ¡ duplicada no lote.`,
      )
    }
    ...
    return {
      ...
      errors: [
        error instanceof Error
          ? error.message
          : 'Erro inesperado ao processar a evidÃªncia.',
      ],
    ...
    item => ({
      ...
      warnings:
        ...
        0
          ? []
          : [
              'A evidÃªncia ainda nÃ£o possui vÃ­nculo com o Knowledge Graph.',
            ],
