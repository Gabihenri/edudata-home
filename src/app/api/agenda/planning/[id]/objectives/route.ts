...
import {
  ...
  type PlanningObjectiveSelection,
...
export async function GET(
  ...
  try {
    ...
    console.error(
      '[AGENDA_PLANNING_OBJECTIVES_GET_ERROR]',
      error,
    )
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      {
        ...
        message:
          'Objetivo vinculado ao planejamento com sucesso.',
    ...
    console.error(
      '[AGENDA_PLANNING_OBJECTIVES_POST_ERROR]',
      error,
    )
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      {
        ...
        message:
          'Objetivos do planejamento sincronizados com sucesso.',
    ...
    console.error(
      '[AGENDA_PLANNING_OBJECTIVES_PUT_ERROR]',
      error,
    )
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      {
        ...
        message:
          'Objetivos removidos do planejamento com sucesso.',
      },
      {
        status:
          200,
    ...
    console.error(
      '[AGENDA_PLANNING_OBJECTIVES_DELETE_ERROR]',
      error,
    )
