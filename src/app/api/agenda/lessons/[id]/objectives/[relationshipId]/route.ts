...
import {
  ...
  type UpdateLessonObjectiveLinkInput,
...
function validateLessonRelationship(
  lessonId: string,
  relationshipLessonId: string,
): void {
  if (
    lessonId !==
    relationshipLessonId
  ) {
    throw new Error(
      'O vínculo informado não pertence à aula solicitada.',
    )
  }
}
...
export async function GET(
  ...
  try {
    ...
    console.error(
      '[AGENDA_LESSON_OBJECTIVE_RELATIONSHIP_GET_ERROR]',
      error,
    )

    return createErrorResponse(
      error,
      'Não foi possível carregar o vínculo entre aula e objetivo.',
    )
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json(
      {
        ...
        message:
          'Vínculo entre aula e objetivo atualizado com sucesso.',
    ...
    console.error(
      '[AGENDA_LESSON_OBJECTIVE_RELATIONSHIP_PATCH_ERROR]',
      error,
    )

    return createErrorResponse(
      error,
      'Não foi possível atualizar o vínculo entre aula e objetivo.',
    )
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      {
        ...
        message:
          'Objetivo removido da aula com sucesso.',
      },
      {
        status:
          200,
    ...
    console.error(
      '[AGENDA_LESSON_OBJECTIVE_RELATIONSHIP_DELETE_ERROR]',
      error,
    )
