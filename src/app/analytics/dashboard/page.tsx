...
export const metadata: Metadata = {
  ...
  description:
    'Ambiente operacional de inteligência educacional, histórico, exploração estatística, evolução, comparação e relatórios do EduData Analytics.',
}
        ...
        <div className="mx-auto max-w-7xl px-4 py-7 sm:px-6 sm:py-9 lg:px-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300 sm:text-base sm:leading-7">Ambiente operacional para análise educacional, exploração estatística, histórico longitudinal, comparação de versões e relatórios institucionais explicáveis.</p>
            </div>
          ...
          <div className="mt-7 grid grid-cols-2 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] sm:grid-cols-4">
            ...
            <div className="border-r border-white/10 px-4 py-4"><p className="text-[10px] font-bold uppercase tracking-[0.14em] text-slate-400">Evoluir</p><p className="mt-1 text-sm font-bold">Tendências</p></div>
