      ...
      <div className="mx-auto flex h-24 max-w-7xl items-center justify-between px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="hidden rounded-full border border-white/20 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10 md:inline-flex"
          >
            Entrar
          </a>
          ...
          <a
            href="/academy"
            className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#050816] transition hover:bg-slate-100"
          >
            Inscrever-se
          </a>
        </div>
