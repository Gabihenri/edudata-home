...
export function AgendaEvidence() {
  ...
  const isSubmitDisabled =
    useMemo(() => {
      ...
      return !isMinorProtectionComplete
    }, [
      form.evidenceType,
      form.externalUrl,
      form.title,
          ...
          >
            ...
            <fieldset className="mt-6 rounded-3xl border border-slate-200 bg-slate-50 p-5">
              <legend className="px-2 text-base font-bold text-slate-900">
                A evidência contém criança
                ou adolescente
                identificável?
              </legend>

              <p className="mt-2 text-sm leading-6 text-slate-600">
                Considere rosto, nome,
                matrícula, voz, uniforme,
                escola, localização ou
                    ...
                    <div className="mt-5 flex flex-wrap gap-4">
                      {evidence.file_url ? (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex rounded-full bg-[#6B21A8] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#581C87]"
                        >
                          Abrir arquivo
                        </a>
                      ) : null}
                      ...
                      {evidence.external_url ? (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex rounded-full border border-[#6B21A8] bg-white px-5 py-2.5 text-sm font-semibold text-[#6B21A8] transition hover:bg-purple-50"
                        >
                          Abrir link
                        </a>
                      ) : null}
