...
-- DOC-08: Auth sem permissão de homologação não pode produzir link ativo.
...
-- DOC-09: professor acadêmico pode existir sem Auth/link ativo.
...
-- DOC-17: raw bruto permanece preservado.
...
-- DOC-20: rejeitado/unresolved/ambiguous nunca chegam a identidade canônica.
